...
function validateConfig() {
    ...
    console.log(`   - Google Maps: ${config.google.mapsApiKey ? 'Configured' : 'Missing'}`);
    console.log(`   - Zoho CRM: ${config.zoho.clientId ? 'Configured' : 'Missing'}`);
    console.log(`   - Features: PDF=${config.features.pdfGeneration}, Batch=${config.features.batchProcessing}`);
